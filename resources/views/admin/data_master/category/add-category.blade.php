                            ...
                            <form action="{{ route('category.store') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-10">
                                        <input class="form-control" type="text" name="nama_category" placeholder="Input Category" value="{{ old('nama_category')}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-2 col-form-label">slug</label>
                                    <div class="col-sm-12 col-md-10">
                                        <input class="form-control" placeholder="input slug" name="slug" type="text" value="{{ old('slug')}}">
                                    </div>
                                </div>
